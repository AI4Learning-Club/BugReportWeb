...
export default function AiGuide() {
  ...
  useEffect(() => {
    fetch(`${import.meta.env.BASE_URL}content/ai-guide.md`)
      .then((response) => {
        if (!response.ok) {
  ...
  if (error) {
    return <div className="ai-guide-error">无法加载 AI 代理指南：{error}</div>;
  }

  if (!markdown) {
    return <div className="ai-guide-loading">加载 AI 代理指南…</div>;
  }
